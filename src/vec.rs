...
macro_rules! vec_impl_cmp {
    ($(#[$attrs:meta])*, $Vec:ident, $cmp:ident, $op:tt, $Bounds:tt) => {
        $(#[$attrs])*
        pub fn $cmp(&self, rhs: &Self) -> $Vec<bool> where T: $Bounds {
            let mut out: $Vec<bool> = unsafe { mem::uninitialized() };
            let mut iter = self.iter().zip(rhs.iter());
            for elem in &mut out {
    ...
    (common $Vec:ident $vec:ident ($dim:expr) ($fmt:expr) ($($get:tt)+) ($($namedget:tt)+) ($($tupleget:tt)+) $Tuple:ty) => {
        ...
        */
		...
		out
            ...
            /// assert_eq!(v, s.sqrt());
            /// ```
            pub fn sqrt(mut self) -> Self where T: Float {
            ...
            /// assert_eq!(s, v.recip());
            /// ```
            pub fn recip(mut self) -> Self where T: Float {
                for elem in &mut self {
                    *elem = elem.recip();
                }
                self
            ...
            /// ```
            pub fn ceil(mut self) -> Self where T: Float {
                for elem in &mut self {
                    *elem = elem.ceil();
                }
                self
            ...
            /// ```
            pub fn floor(mut self) -> Self where T: Float {
                for elem in &mut self {
                    *elem = elem.floor();
                }
                self
            ...
            /// ```
            pub fn round(mut self) -> Self where T: Float {
                for elem in &mut self {
                    *elem = elem.round();
                }
                self
            ...
            vec_impl_cmp!{
                ...
                /// let u = Vec4(0,2,2,6);
                /// let v = Vec4(0,1,2,3);
                /// assert_eq!(u.partial_cmpeq(v), Vec4(true, false, true, false));
                /// ```
            ...
            vec_impl_cmp!{
                ...
                /// let u = Vec4(0,2,2,6);
                /// let v = Vec4(0,1,2,3);
                /// assert_eq!(u.partial_cmpne(v), Vec4(false, true, false, true));
                /// ```
            ...
            vec_impl_cmp!{
                ...
                /// let u = Vec4(0,2,2,2);
                /// let v = Vec4(0,1,2,3);
                /// assert_eq!(u.partial_cmpge(v), Vec4(true, true, true, false));
                /// ```
            ...
            vec_impl_cmp!{
                ...
                /// let u = Vec4(0,2,2,6);
                /// let v = Vec4(0,1,2,3);
                /// assert_eq!(u.partial_cmpgt(v), Vec4(false, true, false, true));
                /// ```
            ...
            vec_impl_cmp!{
                ...
                /// let u = Vec4(0,2,2,2);
                /// let v = Vec4(0,1,2,3);
                /// assert_eq!(u.partial_cmple(v), Vec4(true, false, true, true));
                /// ```
            ...
            vec_impl_cmp!{
                ...
                /// let u = Vec4(0,2,2,2);
                /// let v = Vec4(0,1,2,3);
                /// assert_eq!(u.partial_cmplt(v), Vec4(false, false, false, true));
                /// ```
            ...
            vec_impl_cmp!{
                ...
                /// let u = Vec4(0,2,2,6);
                /// let v = Vec4(0,1,2,3);
                /// assert_eq!(u.cmpne(v), Vec4(false, true, false, true));
                /// ```
                , $Vec, cmpne, !=, Eq
            }
            ...
            vec_impl_cmp!{
                ...
                /// let u = Vec4(0,2,2,2);
                /// let v = Vec4(0,1,2,3);
                /// assert_eq!(u.cmpge(v), Vec4(true, true, true, false));
                /// ```
                , $Vec, cmpge, >=, Ord
            }
            ...
            vec_impl_cmp!{
                ...
                /// let u = Vec4(0,2,2,6);
                /// let v = Vec4(0,1,2,3);
                /// assert_eq!(u.cmpgt(v), Vec4(false, true, false, true));
                /// ```
                , $Vec, cmpgt, >, Ord
            }
            ...
            vec_impl_cmp!{
                ...
                /// let u = Vec4(0,2,2,2);
                /// let v = Vec4(0,1,2,3);
                /// assert_eq!(u.cmple(v), Vec4(true, false, true, true));
                /// ```
                , $Vec, cmple, <=, Ord
            }
            ...
            vec_impl_cmp!{
                ...
                /// let u = Vec4(0,2,2,2);
                /// let v = Vec4(0,1,2,3);
                /// assert_eq!(u.cmplt(v), Vec4(false, false, false, true));
                /// ```
                , $Vec, cmplt, <, Ord
            }
        }
...
macro_rules! vec_impl_all_vecs {
    ($(#[$attrs:meta])+) => {
        ...
        // TODO uncomment a lot of stuff below when I'm done with implementations
